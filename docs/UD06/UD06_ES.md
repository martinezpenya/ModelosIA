...
- **Entregas** — tres, [qué se entrega y cuándo](UD06_Entregas.md):
...
| Peso | Instrumento |
|---|---|
| **40 %** actividades | **Debate 1** y **Debate 2**, con la [rúbrica de debate](UD06_Entregas.md) (5 criterios, 100 puntos, escalados sobre 10), y el taller **T02** de auditoría de sesgos. El taller **T01** y el notebook **`N01`** son práctica y no puntúan |
