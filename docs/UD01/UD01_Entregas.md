...
!!! important "Qué se entrega en esta unidad"
    Los **cuatro talleres** del RA1 son entregas evaluables: cada uno se corrige con su rúbrica, que
    puedes leer **antes** de empezar en la propia tarea de Moodle. El peso de cada entrega está en el
    **libro de calificaciones de Moodle**, no aquí, para que no haya dos versiones del mismo dato.
...
## N02 · Mapa de sistemas inteligentes

Identificar sistemas inteligentes en un entorno real y decidir, con criterio normativo, cuáles
son de verdad sistemas de IA.

**Se entrega**: un mapa de 3 sistemas con su ficha, su clasificación y una conclusión.

## N03 · Técnicas de IA en casos reales

Clasificar técnicas de IA, justificar la elección y comprobarla contra la documentación oficial.

**Se entrega**: una tabla de decisión técnica de 6 casos, contrastada con fuentes.

## N04 · Nuevas formas de interacción

Diseñar una mejora operativa basada en nuevas formas de interacción, estimar su impacto y
anticipar sus fricciones reales.

**Se entrega**: una propuesta con línea base, indicadores, fricciones y riesgos.

## N05 · Línea del tiempo de la IA
