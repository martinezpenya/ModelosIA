...
Es la demostración en código de las técnicas de IA vistas en la teoría: **aprendizaje supervisado**,
**no supervisado** y cómo medir la mejora operativa con `numpy`, `pandas` y `scikit-learn` — las
mismas técnicas del §4 y §6, aplicadas.
